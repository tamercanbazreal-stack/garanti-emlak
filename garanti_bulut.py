...
with st.sidebar:
    ...
    st.image("https://i.hizliresim.com/iwyt3qr.png", width=520)
    st.markdown("<h1 style='text-align: center; color: #FFD700;'>Kurumsal Emlak Yönetim</h1>", unsafe_allow_html=True)
    st.markdown("---")
